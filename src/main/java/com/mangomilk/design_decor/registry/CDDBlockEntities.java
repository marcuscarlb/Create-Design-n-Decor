...
import com.mangomilk.design_decor.blocks.containers.black.BlackContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.blue.BlueContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.brown.BrownContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.cyan.CyanContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.gray.GrayContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.green.GreenContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.light_blue.LightBlueContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.light_gray.LightGrayContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.lime.LimeContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.magenta.MagentaContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.orange.OrangeContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.pink.PinkContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.purple.PurpleContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.red.RedContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.white.WhiteContainerBlockEntity;
import com.mangomilk.design_decor.blocks.containers.yellow.YellowContainerBlockEntity;
...
public class CDDBlockEntities {
    ...
    public static final BlockEntityEntry<GreenContainerBlockEntity> GREEN_CONTAINER = REGISTRATE
            ...
            .validBlocks(CDDBlocks.GREEN_CONTAINER)
            .register();
    ...
    public static final BlockEntityEntry<BlueContainerBlockEntity> BLUE_CONTAINER = REGISTRATE
            ...
            .validBlocks(CDDBlocks.BLUE_CONTAINER)
            .register();

	public static final BlockEntityEntry<BlackContainerBlockEntity> BLACK_CONTAINER = REGISTRATE
			.blockEntity("black_container", BlackContainerBlockEntity::new)
			.validBlocks(CDDBlocks.BLACK_CONTAINER)
			.register();

	public static final BlockEntityEntry<BrownContainerBlockEntity> BROWN_CONTAINER = REGISTRATE
			.blockEntity("brown_container", BrownContainerBlockEntity::new)
			.validBlocks(CDDBlocks.BROWN_CONTAINER)
			.register();

	public static final BlockEntityEntry<CyanContainerBlockEntity> CYAN_CONTAINER = REGISTRATE
			.blockEntity("cyan_container", CyanContainerBlockEntity::new)
			.validBlocks(CDDBlocks.CYAN_CONTAINER)
			.register();

	public static final BlockEntityEntry<GrayContainerBlockEntity> GRAY_CONTAINER = REGISTRATE
			.blockEntity("gray_container", GrayContainerBlockEntity::new)
			.validBlocks(CDDBlocks.GRAY_CONTAINER)
			.register();

	public static final BlockEntityEntry<LightBlueContainerBlockEntity> LIGHT_BLUE_CONTAINER = REGISTRATE
			.blockEntity("light_blue_container", LightBlueContainerBlockEntity::new)
			.validBlocks(CDDBlocks.LIGHT_BLUE_CONTAINER)
			.register();

	public static final BlockEntityEntry<LightGrayContainerBlockEntity> LIGHT_GRAY_CONTAINER = REGISTRATE
			.blockEntity("light_gray_container", LightGrayContainerBlockEntity::new)
			.validBlocks(CDDBlocks.LIGHT_GRAY_CONTAINER)
			.register();

	public static final BlockEntityEntry<LimeContainerBlockEntity> LIME_CONTAINER = REGISTRATE
			.blockEntity("lime_container", LimeContainerBlockEntity::new)
			.validBlocks(CDDBlocks.LIME_CONTAINER)
			.register();

	public static final BlockEntityEntry<MagentaContainerBlockEntity> MAGENTA_CONTAINER = REGISTRATE
			.blockEntity("magenta_container", MagentaContainerBlockEntity::new)
			.validBlocks(CDDBlocks.MAGENTA_CONTAINER)
			.register();

	public static final BlockEntityEntry<OrangeContainerBlockEntity> ORANGE_CONTAINER = REGISTRATE
			.blockEntity("orange_container", OrangeContainerBlockEntity::new)
			.validBlocks(CDDBlocks.ORANGE_CONTAINER)
			.register();

	public static final BlockEntityEntry<PinkContainerBlockEntity> PINK_CONTAINER = REGISTRATE
			.blockEntity("pink_container", PinkContainerBlockEntity::new)
			.validBlocks(CDDBlocks.PINK_CONTAINER)
			.register();

	public static final BlockEntityEntry<PurpleContainerBlockEntity> PURPLE_CONTAINER = REGISTRATE
			.blockEntity("purple_container", PurpleContainerBlockEntity::new)
			.validBlocks(CDDBlocks.PURPLE_CONTAINER)
			.register();

	public static final BlockEntityEntry<WhiteContainerBlockEntity> WHITE_CONTAINER = REGISTRATE
			.blockEntity("white_container", WhiteContainerBlockEntity::new)
			.validBlocks(CDDBlocks.WHITE_CONTAINER)
			.register();

	public static final BlockEntityEntry<YellowContainerBlockEntity> YELLOW_CONTAINER = REGISTRATE
			.blockEntity("yellow_container", YellowContainerBlockEntity::new)
			.validBlocks(CDDBlocks.YELLOW_CONTAINER)
			.register();
