...
import com.mangomilk.design_decor.blocks.beam.BeamBlock;
import com.mangomilk.design_decor.blocks.beam.BeamCTBehaviour;
...
import com.mangomilk.design_decor.blocks.containers.black.BlackContainerBlock;
import com.mangomilk.design_decor.blocks.containers.black.BlackContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.black.BlackContainerItem;
...
import com.mangomilk.design_decor.blocks.containers.brown.BrownContainerBlock;
import com.mangomilk.design_decor.blocks.containers.brown.BrownContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.brown.BrownContainerItem;
import com.mangomilk.design_decor.blocks.containers.cyan.CyanContainerBlock;
import com.mangomilk.design_decor.blocks.containers.cyan.CyanContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.cyan.CyanContainerItem;
import com.mangomilk.design_decor.blocks.containers.gray.GrayContainerBlock;
import com.mangomilk.design_decor.blocks.containers.gray.GrayContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.gray.GrayContainerItem;
...
import com.mangomilk.design_decor.blocks.containers.light_blue.LightBlueContainerBlock;
import com.mangomilk.design_decor.blocks.containers.light_blue.LightBlueContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.light_blue.LightBlueContainerItem;
import com.mangomilk.design_decor.blocks.containers.light_gray.LightGrayContainerBlock;
import com.mangomilk.design_decor.blocks.containers.light_gray.LightGrayContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.light_gray.LightGrayContainerItem;
import com.mangomilk.design_decor.blocks.containers.lime.LimeContainerBlock;
import com.mangomilk.design_decor.blocks.containers.lime.LimeContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.lime.LimeContainerItem;
import com.mangomilk.design_decor.blocks.containers.magenta.MagentaContainerBlock;
import com.mangomilk.design_decor.blocks.containers.magenta.MagentaContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.magenta.MagentaContainerItem;
import com.mangomilk.design_decor.blocks.containers.orange.OrangeContainerBlock;
import com.mangomilk.design_decor.blocks.containers.orange.OrangeContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.orange.OrangeContainerItem;
import com.mangomilk.design_decor.blocks.containers.pink.PinkContainerBlock;
import com.mangomilk.design_decor.blocks.containers.pink.PinkContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.pink.PinkContainerItem;
import com.mangomilk.design_decor.blocks.containers.purple.PurpleContainerBlock;
import com.mangomilk.design_decor.blocks.containers.purple.PurpleContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.purple.PurpleContainerItem;
...
import com.mangomilk.design_decor.blocks.containers.white.WhiteContainerBlock;
import com.mangomilk.design_decor.blocks.containers.white.WhiteContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.white.WhiteContainerItem;
import com.mangomilk.design_decor.blocks.containers.yellow.YellowContainerBlock;
import com.mangomilk.design_decor.blocks.containers.yellow.YellowContainerCTBehaviour;
import com.mangomilk.design_decor.blocks.containers.yellow.YellowContainerItem;
...
import com.mangomilk.design_decor.blocks.metal_support.LargeGirderBlock;
...
public class CDDBlocks {
	...
	public static final BlockEntry<LargeGirderBlock> LARGE_METAL_GIRDER = REGISTRATE.block("large_metal_girder", LargeGirderBlock::new)
			...
			.recipe((c, p) -> ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, c.get(), 1)
					...
					.unlockedBy("has_" + c.getName(), has(c.get())).save(p, DesignDecor.asResource("crafting/" + c.getName()))
			).transform(pickaxeOnly())
			.onRegister(CreateRegistrate.connectedTextures(() -> new RotatedPillarCTBehaviour(rectangle("large_girder"), omni("large_girder_top"))))
			.blockstate((c, p) -> p.axisBlock(c.get(), DesignDecor.asResource("block/large_girder"), DesignDecor.asResource("block/large_girder_top")))
			.simpleItem()
			.register();
	...
	public static final BlockEntry<BeamBlock> BEAM = REGISTRATE.block("beam", BeamBlock::new)
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get()).forAllStates(s -> {
				...
				var modelBoth = p.models().getExistingFile(DesignDecor.asResource("block/beam/block" + axis));
				var modelTop = p.models().getExistingFile(DesignDecor.asResource("block/beam/top" + axis));
				var modelBottom = p.models().getExistingFile(DesignDecor.asResource("block/beam/bottom" + axis));
			...
			.transform(pickaxeOnly())
			.item()
			.model((c, p) -> p.withExistingParent("item/" + c.getName(), DesignDecor.asResource("block/beam/item")))
			.build()
			.lang("Beam")
			.register();
    //LAMPS
...
//            .register();
	...
	public static final BlockEntry<BlackContainerBlock> BLACK_CONTAINER = REGISTRATE.block("black_container",BlackContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(BlackContainerCTBehaviour::new))
			.item(BlackContainerItem::new)
			.build()
			.lang("Black Container")
			.register();

	public static final BlockEntry<BrownContainerBlock> BROWN_CONTAINER = REGISTRATE.block("brown_container",BrownContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(BrownContainerCTBehaviour::new))
			.item(BrownContainerItem::new)
			.build()
			.lang("Brown Container")
			.register();

	public static final BlockEntry<CyanContainerBlock> CYAN_CONTAINER = REGISTRATE.block("cyan_container",CyanContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(CyanContainerCTBehaviour::new))
			.item(CyanContainerItem::new)
			.build()
			.lang("Cyan Container")
			.register();

	public static final BlockEntry<GrayContainerBlock> GRAY_CONTAINER = REGISTRATE.block("gray_container",GrayContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(GrayContainerCTBehaviour::new))
			.item(GrayContainerItem::new)
			.build()
			.lang("Gray Container")
			.register();

	public static final BlockEntry<LightBlueContainerBlock> LIGHT_BLUE_CONTAINER = REGISTRATE.block("light_blue_container",LightBlueContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(LightBlueContainerCTBehaviour::new))
			.item(LightBlueContainerItem::new)
			.build()
			.lang("Light Blue Container")
			.register();

	public static final BlockEntry<LightGrayContainerBlock> LIGHT_GRAY_CONTAINER = REGISTRATE.block("light_gray_container",LightGrayContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(LightGrayContainerCTBehaviour::new))
			.item(LightGrayContainerItem::new)
			.build()
			.lang("Light Gray Container")
			.register();

	public static final BlockEntry<LimeContainerBlock> LIME_CONTAINER = REGISTRATE.block("lime_container",LimeContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(LimeContainerCTBehaviour::new))
			.item(LimeContainerItem::new)
			.build()
			.lang("Lime Container")
			.register();

	public static final BlockEntry<MagentaContainerBlock> MAGENTA_CONTAINER = REGISTRATE.block("magenta_container",MagentaContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(MagentaContainerCTBehaviour::new))
			.item(MagentaContainerItem::new)
			.build()
			.lang("Magenta Container")
			.register();

	public static final BlockEntry<OrangeContainerBlock> ORANGE_CONTAINER = REGISTRATE.block("orange_container",OrangeContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(OrangeContainerCTBehaviour::new))
			.item(OrangeContainerItem::new)
			.build()
			.lang("Orange Container")
			.register();

	public static final BlockEntry<PinkContainerBlock> PINK_CONTAINER = REGISTRATE.block("pink_container",PinkContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(PinkContainerCTBehaviour::new))
			.item(PinkContainerItem::new)
			.build()
			.lang("Pink Container")
			.register();

	public static final BlockEntry<PurpleContainerBlock> PURPLE_CONTAINER = REGISTRATE.block("purple_container",PurpleContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(PurpleContainerCTBehaviour::new))
			.item(PurpleContainerItem::new)
			.build()
			.lang("Purple Container")
			.register();

	public static final BlockEntry<WhiteContainerBlock> WHITE_CONTAINER = REGISTRATE.block("white_container",WhiteContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(WhiteContainerCTBehaviour::new))
			.item(WhiteContainerItem::new)
			.build()
			.lang("White Container")
			.register();

	public static final BlockEntry<YellowContainerBlock> YELLOW_CONTAINER = REGISTRATE.block("yellow_container",YellowContainerBlock::new)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.COLOR_GREEN))
			.properties(p -> p.sound(SoundType.NETHERITE_BLOCK)
					.explosionResistance(1200))
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(s -> ConfiguredModel.builder()
							...
							.rotationY(s.getValue(RedContainerBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 90 : 0)
							.build()))
			.onRegister(connectedTextures(YellowContainerCTBehaviour::new))
			.item(YellowContainerItem::new)
			.build()
			.lang("Yellow Container")
			.register();
